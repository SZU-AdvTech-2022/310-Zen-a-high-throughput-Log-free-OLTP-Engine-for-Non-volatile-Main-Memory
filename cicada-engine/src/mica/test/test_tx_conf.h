...
static constexpr uint64_t kPmemPreMallocPow2 = (39UL);

// static constexpr uint64_t kPreMallocSize = (1UL<<kPreMallocPow2);
// static constexpr uint64_t kPmemPreMallocSize = (1UL<<kPmemPreMallocPow2);

static uint64_t kPreMallocSize =    (16UL<<30);
static uint64_t kPmemPreMallocSize = (64UL<<30);
// static constexpr uint64_t kPmemPreMallocSize = (650UL<<30);
