...
#define MICA_ALLOC_SIZE    (16UL<<30)
#define MICA_AEPALLOC_SIZE (64UL<<30)
#define ZEN_CACHE_RATE     (4)
...
#define THREAD_ARENA_SIZE			(1UL << 20)
#define MEM_PAD 					true

// [PART_ALLOC]
#define PART_ALLOC 					false
#define MEM_SIZE					(4UL << 30)
#define NO_FREE						false

// [RCU_ALLOC]
#define RCU_ALLOC 					false
#define RCU_ALLOC_SIZE     (5 * 1073741824UL)	// 20 GB
...
#define SIMPLE_INDEX_UPDATE true
//
